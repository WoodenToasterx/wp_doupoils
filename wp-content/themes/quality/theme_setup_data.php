...
{	
	return $theme_options=array(
			...
			'footer_copyright_text' => '<p>'.__( '<a href="https://wordpress.org">Proudly powered by WordPress</a> & toto | Theme: <a href="https://webriti.com" rel="designer">Quality</a> by Webriti', 'quality' ).'</p>',
		);
}
?>